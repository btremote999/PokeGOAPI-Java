...
public class News {
	...
	public void markUnreadNews(){
        ...
        // JAVA 8 (not support for lower android api < 24)
//        Set<String> filteredNews = currentNews.getNewsArticlesList().stream()
//                .filter(p                -> p.getEnabled() && !p.getArticleRead())
//                .map(NewsArticleOuterClass.NewsArticle::getId)
//                .collect(Collectors.toSet());

        // get enabled and un-read article
